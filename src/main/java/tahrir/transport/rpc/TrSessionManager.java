...
import tahrir.util.tools.ByteArraySegment.ByteArraySegmentBuilder;
		...
		try {
			if (cls.getConstructor(Integer.class, TrNode.class, TrSessionManager.class) == null)
				throw new RuntimeException(
						cls
						+ " must have a constructor that takes parameters (java.lang.Integer, tahrir.TrNode, tahrir.io.network.TrNet)");
